...
extension BottomNavigationView {
    ...
    func setMarketButtonView() {
        ...
        marketImageView.snp.makeConstraints {
            ...
            $0.bottom.equalTo(marketButtonView.snp.centerY).offset(-2 * ScreenFigure.VRatioValue)
            $0.width.height.equalTo(18 * ScreenFigure.VRatioValue)
        }
        marketTitleLabel.snp.makeConstraints {
            $0.centerX.equalToSuperview()
            $0.top.equalTo(marketButtonView.snp.centerY).offset(2 * ScreenFigure.VRatioValue)
        }
    ...
    func setAssetView() {
        ...
        assetImageView.snp.makeConstraints {
            $0.centerX.equalToSuperview()
            $0.bottom.equalTo(assetButtonView.snp.centerY).offset(-2 * ScreenFigure.VRatioValue)
            $0.width.height.equalTo(18 * ScreenFigure.VRatioValue)
        }
        assetTitleLabel.snp.makeConstraints {
            $0.centerX.equalToSuperview()
            $0.top.equalTo(assetButtonView.snp.centerY).offset(2 * ScreenFigure.VRatioValue)
        }
